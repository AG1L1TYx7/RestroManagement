...
const CreateSupplierModal = ({ show, onHide }) => {
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      ...
      setSubmitError(error.message || 'Failed to create supplier')
    }
  }
  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Form onSubmit={handleSubmit(onFormSubmit)}>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={handleClose} disabled={createSupplierMutation.isPending}>
            Cancel
          </Button>
          <Button variant="primary" type="submit" disabled={createSupplierMutation.isPending}>
